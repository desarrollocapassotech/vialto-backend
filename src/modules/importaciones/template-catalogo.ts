...
const MODULOS: Record<string, ModuloDef> = {
  ...
  viajes: {
    ...
    overlays: {
      ...
      fechaCarga: { systemRequired: true, campoLabel: "Fecha de carga", defaultExcelHeader: "Fecha carga", excelHeaderAliases: ["fecha carga", "Fecha de carga"] },
      fechaDescarga: { campoLabel: "Fecha de descarga", defaultExcelHeader: "Fecha descarga", excelHeaderAliases: ["fecha descarga", "Fecha de descarga"] },
