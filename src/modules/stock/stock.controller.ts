...
export class StockController {
  ...
  @ApiOperation({
    summary: "Actualizar producto (incluye desactivar: { activo: false })",
  })
  @Patch("productos/:id")
  @RequireModule("stock", "viajes")
  @Roles("admin", "superadmin")
  ...
  @ApiOperation({
    summary: "Eliminar presentación de un producto (solo si sin movimientos)",
  })
  ...
  removeProductoPresentacion(
    ...
    assertTenantId(auth.tenantId);
    return this.service.removeProductoPresentacion(
      productoId,
      ppId,
      auth.tenantId,
    );
  ...
  @ApiOperation({
    summary: "Registrar movimiento de stock (ingreso, egreso, división)",
  })
  @Post("movimientos")
  @Roles("admin", "superadmin")
  createMovimiento(
  ...
  @ApiOperation({
    summary: "Actualizar formato del número de remito en egresos",
  })
  ...
  @ApiOperation({
    summary:
      "Registrar división de bultos (convierte pallets ↔ suelto, actualiza stock)",
  })
  @Post("divisiones")
  @Roles("admin", "superadmin")
  createDivision(
  ...
  @ApiOperation({
    summary: "Lotes históricos ingresados (para autocompletado)",
  })
  @Get("lotes/historico")
  @Roles("admin", "superadmin")
  getLotesHistorico(
